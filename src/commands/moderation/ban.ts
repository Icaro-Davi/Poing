...
import { confirmBanishMember } from "../../components/messageEmbed";
import messageToBanishedMember from "../../components/messageEmbed/messageToBanishedMember";
        ...
        collector.on('end', async (buttonInteraction) => {
            try {
                ...
                if (buttonId === component.button.yesId) {
                    ...
                    member.send({
                        embeds: [messageToBanishedMember({
